...
l %>%
  ...
  addCircleMarkers(data = Rewilding, group = "Rewildling", popup = ~Name, color = "#e78ac3") %>% 
  addCircleMarkers(data = Sinks, color = "#fc8d62", group = "Sinks", popup = ~Dato) %>% 
  addLegend(colors = c("#8da0cb", "#e78ac3", "#fc8d62", "#66c2a5"), labels = c("Catchment","Rewildling", "Sinks", "National Parks")) %>% 
