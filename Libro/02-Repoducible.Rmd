...
This chapter will explain what reproducible research is, how to apply it using github plus the *rmarkdown* [@Allaire2018] and *knitr* [@xie2015] packages. Also, you will learn how to use tables using *knitr* [@xie2015] and *kableExtra* [@Hao2021]. Finally you will learn how use reprex in order to generate reproducible questions in stackoverflow.

This class of the course can also be followed at this [link](https://sustainscapes.github.io/Class2/Clase2InvestigacionReproducible). 
