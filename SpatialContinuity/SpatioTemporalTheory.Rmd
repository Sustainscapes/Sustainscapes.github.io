...
```{r newedges, echo=FALSE, cache=TRUE}
library(patchwork)
Graphs <- list()

Distances <- c(2000, 5000, 10000, 50000)
...
saveRDS(net, paste("net", Distances[i], ".rds"))
